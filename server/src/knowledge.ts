...
Ball mastery & dribbling (Zone 1 staples): circle warm-up — ball per player on the outside, middle players rotate through 2-min bouts of one-touch, two-touch, volleys (chest/thigh/laces), half-turn dribble-and-return; four-group central-cone dribbling — first player dribbles to the middle cone, executes a specified move faking one way going the other; cone-gate game — dribble through as many gates as possible in 45s, coach blocks gates to force direction changes; cone races with move variations both feet; mannequin/cone move lines — inside cut, outside chop, scissors, V-move, pull-back, inside-outside, Matthews, step-over-turn, Maradona spin, roll-over, all at pace with acceleration after the move; 3-person turn sequence — pass into an attacker who turns a passive defender (outside foot, inside foot, Zico, Cruyff), roles rotate; pass-dribble-tag in 10x10 grids.
...
Defending: 1v1 with two cone gates — approach fast, get low, short steps, never flat-footed, never give up when beaten; chase-around 1v1 — pass then sprint around the grid to defend; knock-the-ball-off-the-cone 1v1; 3v2-to-1v1 defensive transition channels; early pressure/cover/balance — 4v4+1 target forward, deny the entry ball, "the right player steps to the ball"; 6v4+6v4 and 7v4+7v4 pressure-cover-balance blocks — deny entry to the forwards behind you, DO NOT get beat down the middle, high intensity, forwards must combine to score; 7v5 recover-and-delay after the possession team completes 7 passes; 6v6 with counter goals played as a defensive patience exercise; 4v2+2 counter-attack defending — CBs contain and delay while two defenders recover; defending the cross and second phase (2v1 wide → cross → immediate 4v2 second ball); aerial knock-down game — back four connect 6 passes in their box then launch, opponents clear at all costs.

Transitions: 4v4+3 with the 6/8 as the pivot, "head on a swivel"; 4v2-to-6v4 counter-press — lose it in the small square, hunt it back instantly; 8v4+1 grid-to-grid with a 2-touch link player; 3-team 6v3 — the team that loses it defends; 2v1-to-4v2 driving to goal; wide combination into 3v2 transition; 4v2 crossing transition off keeper throws (doubles as fitness); wave game building 2v0 → 3v2 → 3v4 → 6v4 → 6v8 → 8v8 with width arriving mid-sequence; call-off game — coach calls a letter/number and that player sprints off as a new one enters, both teams must react.

Fitness (Zone 2 only, always age-appropriate): 15-15 shuttles — 18-yard box to midfield and back, 15s work / 15s rest, build from 6 to 8 minutes across weeks; 120-yard shuffle — 10, 20, 30 yards and back under 25s, rest the remainder of the minute, 6 reps; zig-zag speed and agility. Never assign this kind of conditioning to Zone 1.
