...
const TOPICS: Topic[] = [
  // technical
  { id: "ball-mastery", name: "Ball Mastery & First Touch", phase: "technical", emoji: "🎯", minBand: 0, concept: "High-repetition ball manipulation: sole rolls, cuts, turns, receiving with all surfaces, touch away from pressure. Signature exercises: circle warm-up (outside players feed rotating middle players — one-touch, two-touch, volleys, half-turn dribble); turn repertoire lines (Cruyff, chop, pull-back, Zico, inside/outside cut) with a burst of pace after every turn; 3-person turn sequence where the passer becomes the passive defender." },
  ...
  { id: "1v1-attacking", name: "1v1 Attacking Moves", phase: "technical", emoji: "⚡", minBand: 0, concept: "Beating a defender: feints, changes of speed and direction, protecting the ball, bravery to take players on. Signature exercises: mannequin/cone move lines (scissors, V-move, Matthews, Maradona spin, step-over-turn) executed at pace with acceleration after the move; sprint-then-1v1 to goal ('if you're ahead of the defender, take the early chance'); three-grid 1v1s where the defender counters into a mini goal." },
  ...
  { id: "possession-games", name: "Possession Games & Overloads", phase: "possession", emoji: "🎲", minBand: 1, concept: "Directional possession with overloads (4v2 to 8v6), keep-to-penetrate decision making. Signature exercises: 4v4+2 wide neutrals at 2 touches; 6v6+6 three-mini-goal game (on regain you MUST play out to the 1-touch neutral team); 4-corner possession (connect your corner to the opposite one); 6v2 with 3 goals (10 passes = 1 point, defenders counter into small goals for 2); 8v8+4 positional possession with neutrals occupying real positions (4, 7, 9, 11); 7v5 positional game with players locked to grids until regain; 8v3 box game." },
  ...
  // athletic
  { id: "speed-agility", name: "Speed & Agility with the Ball", phase: "athletic", emoji: "💨", minBand: 1, concept: "Acceleration, change of direction, and coordination woven into ball work — never bare cones-only running. For U13+ only, proven conditioning protocols: 15-15 shuttles (18-yard box to midfield and back, 15s work / 15s rest, build 6→8 minutes over weeks); 120-yard shuffle (10/20/30 yards and back under 25s, rest the remainder of the minute, 6 reps); zig-zag agility courses. Younger groups get speed work only through games and races with the ball." },
